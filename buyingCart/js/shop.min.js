//购物车插件  !function(){}(), 立即执行函数，同
//(function(){})(),    (function(){}())   将函数声明转换为函数表达式
//function(){}  是匿名函数， 后面再加一个括号  function(){}()代表是匿名函数自调用
!function(t, e, a, n) {
    "use strict";
    console.log("t", t);    // ƒ (a,b){return new m.fn.init(a,b)} CommonJS模块化规范  jQuery实例
    console.log("e", e);    //window
    console.log("a", a);    //document
    console.log("n", n);    //undefined  没传做一个备用变量
    ...
    //函数声明1
    function i(e, a) {
        this.element = t(e),    //返回JQuery包装过的对象
        this.settings = t.extend(!0, {},s, a),   //购物车一些方法的设置
        this.cart = this.element.find("." + this.settings.cart),  //返回被选中元素的所有.ct-cart后代元素
        this.product = this.element.find("." + this.settings.product),//返回被选中元素的所有.ct-product后代元素
        this._defaults = s,   //默认设置
        this._name = r,      //
        this.init()
    }
	

    //为jQuery扩展一个或多个实例属性和方法     $.fn.extend( object )用来合并到jQuery的原型对象上。
    t.extend(i.prototype, {
        ...
        //清空购物车  点击清空按钮  移除sessionStorage中的cart选项
    ...
    //立即执行  jquery.fn === jquery.prototype
    t.fn[r] = function(e) {
        //从外部进来先执行这个函数进行初始化
        console.log("这个this指向呢", this +"r:", r);   //指向jquery选中的DOM结构
        console.log("打印一下原型结构", t.fn,  "t.prototype:", t.prototype);
        return this.each(function() {
            //为每个元素执行方法，详见JQuery的杂项方法；
            //向被选元素附加数据或获取数据
...
/**
 * $.fn是指jQuery的命名空间，加上fn的方法及属性，会对jQuery实例有效。jquery.fn = jquery.prototype 

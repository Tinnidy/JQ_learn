...
!function(t, e, a, n) {
    "use strict";
    console.log("t", t);    // ƒ (a,b){return new m.fn.init(a,b)} CommonJS模块化规范
    ...
    //函数声明1
    function i(e, a) {
        // console.log("this的指向， 根据函数执行上下文确定", this);  指向i 这个构造函数
        this.element = t(e),
    ...
    //jquery扩展方法声明  将方法合并到i的prototype上
    ...
    //返回一个插件
    t.fn[r] = function(e) {
        //console.log("什么时候执行这个插件方法");  从外部进来先执行这个函数进行初始化
        console.log("这个this指向呢", this);   //指向jquery选中的DOM结构
        return this.each(function() {
            t.data(this, "plugin_" + r) || t.data(this, "plugin_" + r, new i(this, e))
        })
    }

    //console.log("i", i.prototype);   //已经包含了扩展的所有方法
